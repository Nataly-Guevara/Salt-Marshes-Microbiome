...
- `metadata/` — sample metadata, environmental variables, and analysis-ready phyloseq objects
...
| Sample metadata | `metadata_16S.csv` | `metadata_ITS.csv` | `metadata/` |
| Environmental metadata | soil physicochemical variables | soil physicochemical variables | `metadata/` |
...
| Analysis-ready object | `phyloseq_16S.rds` | `phyloseq_ITS.rds` | `metadata/` |
...
The analysis-ready phyloseq objects provided in `metadata/` were generated by combining DADA2-derived ASV count tables, taxonomic assignment tables, and sample metadata.

### 16S phyloseq object

The 16S phyloseq object, `metadata/phyloseq_16S.rds`, was generated using:
...
The ITS phyloseq object, `metadata/phyloseq_ITS.rds`, was generated using:
...
3. Generate the analysis-ready phyloseq objects using:
   - `scripts/DADA2/16S/04_phyloseq_and_clean_taxonomy_16S.R`
   - `scripts/DADA2/ITS/04_phyloseq_and_clean_taxonomy_ITS.R`
4. Use the phyloseq objects in `metadata/` together with the downstream analysis scripts in `scripts/`.
...
| Phyloseq construction | 16S and ITS | `scripts/DADA2/16S/` and `scripts/DADA2/ITS/` | `metadata/phyloseq_16S.rds`, `metadata/phyloseq_ITS.rds` |
