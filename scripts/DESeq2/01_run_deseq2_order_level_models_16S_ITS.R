#01_run_deseq2_order_level_models_16S_ITS.R
#loads cleaned phyloseq objects for 16S and ITS
#agglomerates to Order
#runs DESeq2
#extracts contrasts for Models A, B, and C
#annotates results with taxonomy
#exports the DESeq2 result tables as CSVs.
#============================================================
...
# Model C intentionally retains all Order-level taxa after agglomeration,
# because this broader compartment-wide comparison was designed to be more inclusive
# than Models A and B.
